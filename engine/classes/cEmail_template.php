<?php
	 ...
	 *
	 * @used in  				email_template Function
	 * @created  				13:27 | 05-01-2013
	 * @database table name   	email_template
	 */

	/*
	|--------------------------------------------------------------------------
	| email_template Function in Settings Module
	|--------------------------------------------------------------------------
	|
	...
	*/
	...
	class cEmail_template{
		public $class_settings = array();
		
		private $current_record_id = '';
		
		private $table_name = 'email_template';
		...
		public $table_fields = array(
			'template_name' => 'email_template001',
			'email' => 'email_template002',
			'subject' => 'email_template003',
		);
		...
		private function _display_data_table(){
			...
			if($sql_result && is_array($sql_result)){
				...
				$err->class_that_triggered_error = 'cemail_template.php';
