<?php
    ...
    if( isset( $sys_env[ 'HYELLA_APP_TITLE' ] ) && $sys_env[ 'HYELLA_APP_TITLE' ] ){
	...
	if( isset( $sys_env[ 'NWP_SIGNOUT_REDIRECT_URL' ] ) ){
		if( $sys_env[ 'NWP_SIGNOUT_REDIRECT_URL' ] ){
			define( 'NWP_SIGNOUT_REDIRECT_URL' , $sys_env[ 'NWP_SIGNOUT_REDIRECT_URL' ] );
		}
	}else{
		//define( 'NWP_SIGNOUT_REDIRECT_URL' , '../../' );
	}
	...
	if( isset( $sys_env[ 'MYSQL_BULK_LOAD_FILE_PATH' ] ) ){
		...
		define( 'MYSQL_BULK_LOAD_FILE_PATH' , '/ndid4d-dev-main/engine/tmp/MySQLBulkLoad/data.txt' );
	}
	...
	define( 'USE_FIELD_KEYSIN_DB' , 1 );

    $package_config["plugins_loaded"]['nwp_meta_data'] = 'cNwp_meta_data';
    ...
    $package_config["plugins_loaded"]['nwp_workflow'] = 'cNwp_workflow';
