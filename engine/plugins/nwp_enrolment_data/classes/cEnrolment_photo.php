<?php
/**
 * enrolment_photo Class
 *
 * @used in  				enrolment_photo Function
 * @created  				Bay4 Mike | 10:11 | 22-Sep-2023
 * @database table name   	enrolment_photo
 */
	
	class cEnrolment_photo extends cCustomer_call_log{
		...
		public $table_name = 'enrolment_photo';
		
		public $default_reference = '';
		
		public $label = 'Enrolment Photo Heartbeat';
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/enrolment_photo.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/enrolment_photo.json' ), true );
