<?php
/**
 * enrolment_agent_activity Class
 *
 * @used in  				enrolment_agent_activity Function
 * @created  				Hyella Nathan | 12:20 | 15-Aug-2023
 * @database table name   	enrolment_agent_activity
 */
	
	class cEnrolment_agent_activity extends cCustomer_call_log{
		...
		public $table_name = 'enrolment_agent_activity';
		
		public $default_reference = '';
		
		public $label = 'Enrolment Agent Activity';
		
		private $associated_cache_keys = array(
			'enrolment_agent_activity',
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/enrolment_agent_activity.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/enrolment_agent_activity.json' ), true );
		...
		function enrolment_agent_activity(){
