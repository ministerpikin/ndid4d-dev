<?php
/**
 * enrolment_signature Class
 *
 * @used in  				enrolment_signature Function
 * @created  				Bay4 Mike | 10:11 | 22-Sep-2023
 * @database table name   	enrolment_signature
 */
	
	class cEnrolment_signature extends cCustomer_call_log{
		...
		public $table_name = 'enrolment_signature';
		
		public $default_reference = '';
		
		public $label = 'Enrolment Signature Heartbeat';
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/enrolment_signature.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/enrolment_signature.json' ), true );
