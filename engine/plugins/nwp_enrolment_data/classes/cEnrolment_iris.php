<?php
/**
 * enrolment_iris Class
 *
 * @used in  				enrolment_iris Function
 * @created  				Bay4 Mike | 10:11 | 22-Sep-2023
 * @database table name   	enrolment_iris
 */
	
	class cEnrolment_iris extends cCustomer_call_log{
		...
		public $table_name = 'enrolment_iris';
		
		public $default_reference = '';
		
		public $label = 'Enrolment Iris Heartbeat';
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/enrolment_iris.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/enrolment_iris.json' ), true );
