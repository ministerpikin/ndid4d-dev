<?php
/**
 * enrolment_document Class
 *
 * @used in  				enrolment_document Function
 * @created  				Hyella Nathan | 20:08 | 16-Aug-2023
 * @database table name   	enrolment_document
 */
	
	class cEnrolment_document extends cCustomer_call_log{
		...
		public $table_name = 'enrolment_document';
		
		public $default_reference = '';
		
		public $label = 'Enrolment Document Heartbeat';
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/enrolment_document.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/enrolment_document.json' ), true );
