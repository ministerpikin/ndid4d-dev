<?php
/**
 * enrolment_liveness Class
 *
 * @used in  				enrolment_liveness Function
 * @created  				Bay4 Mike | 10:11 | 22-Sep-2023
 * @database table name   	enrolment_liveness
 */
	
	class cEnrolment_liveness extends cCustomer_call_log{
		...
		public $table_name = 'enrolment_liveness';
		
		public $default_reference = '';
		
		public $label = 'Enrolment Liveness Heartbeat';
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/enrolment_liveness.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/enrolment_liveness.json' ), true );
