<?php
/**
 * enrolment_fingerprint Class
 *
 * @used in  				enrolment_fingerprint Function
 * @created  				Bay4 Mike | 10:11 | 22-Sep-2023
 * @database table name   	enrolment_fingerprint
 */
	
	class cEnrolment_fingerprint extends cCustomer_call_log{
		...
		public $table_name = 'enrolment_fingerprint';
		
		public $default_reference = '';
		
		public $label = 'Enrolment Fingerprint Heartbeat';
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/enrolment_fingerprint.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/enrolment_fingerprint.json' ), true );
		...
		function enrolment_fingerprint(){
