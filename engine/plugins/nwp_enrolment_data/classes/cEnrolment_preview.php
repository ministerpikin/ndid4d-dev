<?php
/**
 * enrolment_preview Class
 *
 * @used in  				enrolment_preview Function
 * @created  				Bay4 Mike | 10:11 | 22-Sep-2023
 * @database table name   	enrolment_preview
 */
	
	class cEnrolment_preview extends cCustomer_call_log{
		...
		public $table_name = 'enrolment_preview';
		
		public $default_reference = '';
		
		public $label = 'Enrolment Preview Heartbeat';
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/enrolment_preview.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/enrolment_preview.json' ), true );
