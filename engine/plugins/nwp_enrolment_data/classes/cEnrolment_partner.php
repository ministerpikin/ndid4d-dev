<?php
/**
 * enrolment_partner Class
 *
 * @used in  				enrolment_partner Function
 * @created  				Hyella Nathan | 12:26 | 15-Aug-2023
 * @database table name   	enrolment_partner
 */
	
	class cEnrolment_partner extends cCustomer_call_log{
		...
		public $table_name = 'enrolment_partner';
		
		public $default_reference = '';
		
		public $label = 'Enrolment Partner';
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/enrolment_partner.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/enrolment_partner.json' ), true );
