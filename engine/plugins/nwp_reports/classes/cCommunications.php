 ...
 *
 * @used in  				communications Function
 * @created  				Hyella Nathan | 10:48 | 30-Aug-2023
 * @database table name   	communications
 */
	
	class cCommunications extends cCustomer_call_log{
		...
		public $table_name = 'communications';
		
		public $default_reference = '';
		
		public $label = 'Enrolee Satisfaction and Dissatisfaction';
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/communications.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/communications.json' ), true );
