<?php
/**
 * project_development Class
 *
 * @used in  				project_development Function
 * @created  				Bay4 Mike | 19:10 | 09-Oct-2023
 * @database table name   	project_development
 */
	
	class cProject_development extends cCustomer_call_log{
		...
		public $table_name = 'project_development';
		
		public $default_reference = '';
		
		public $label = 'Project Development Objectives';
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/project_development.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/project_development.json' ), true );
