<?php
/**
 * social_accountability_monitoring Class
 *
 * @used in  				social_accountability_monitoring Function
 * @created  				Hyella Nathan | 10:44 | 30-Aug-2023
 * @database table name   	social_accountability_monitoring
 */
	
	class cSocial_accountability_monitoring extends cCustomer_call_log{
		...
		public $table_name = 'social_accountability_monitoring';
		
		public $default_reference = '';
		
		public $label = 'Social Accountability Monitoring';
		
		private $associated_cache_keys = array(
			'social_accountability_monitoring',
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/social_accountability_monitoring.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/social_accountability_monitoring.json' ), true );
		...
		function social_accountability_monitoring(){
