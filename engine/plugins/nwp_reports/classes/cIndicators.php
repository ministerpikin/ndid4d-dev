 ...
 * indicators Class
 *
 * @used in  				indicators Function
 * @created  				Hyella Nathan | 15:15 | 06-Dec-2023
 * @database table name   	indicators
 */
	
	class cIndicators extends cCustomer_call_log{
		...
		public $table_name = 'indicators';
		
		public $default_reference = '';
		
		public $label = 'Project Development Objective Indicators';
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/indicators.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/indicators.json' ), true );
