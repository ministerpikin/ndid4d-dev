<?php
/**
 * financial_indicators_on_enrolment_services Class
 *
 * @used in  				financial_indicators_on_enrolment_services Function
 * @created  				Hyella Nathan | 11:00 | 30-Aug-2023
 * @database table name   	financial_indicators_on_enrolment_services
 */
	
	class cFinancial_indicators_on_enrolment_services extends cCustomer_call_log{
		...
		public $table_name = 'financial_indicators_on_enrolment_services';
		
		public $default_reference = '';
		
		public $label = 'Financial Indicators On Enrolment Services';
		
		private $associated_cache_keys = array(
			'financial_indicators_on_enrolment_services',
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/financial_indicators_on_enrolment_services.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/financial_indicators_on_enrolment_services.json' ), true );
		...
		function financial_indicators_on_enrolment_services(){
