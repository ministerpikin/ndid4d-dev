 ...
 * orm_mssql Class
 *
 * @used in  				orm_mssql Function
 * @created  				Bay4 Mike | 02:15 | 21-Jul-2023
 * @database table name   	orm_mssql
 */
	
	class cOrm_mssql extends cCustomer_call_log{
		...
		public $table_name = 'orm_mssql';
		
		public $default_reference = '';
		
		public $label = 'ORM MSSQL';
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/orm_mssql.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/orm_mssql.json' ), true );
