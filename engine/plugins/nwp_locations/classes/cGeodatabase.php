 ...
 * geodatabase Class
 *
 * @used in  				geodatabase Function
 * @created  				Bay4 Mike | 11:28 | 21-Sep-2023
 * @database table name   	geodatabase
 */
	
	class cGeodatabase extends cCustomer_call_log{
		...
		public $table_name = 'geodatabase';
		
		public $default_reference = '';
		
		public $label = 'Nigerian Geodatabase';
		...
		function __construct(){
			...
			if( file_exists( dirname( __FILE__ ).'/dependencies/geodatabase.json' ) ){
				$return = json_decode( file_get_contents( dirname( __FILE__ ).'/dependencies/geodatabase.json' ), true );
