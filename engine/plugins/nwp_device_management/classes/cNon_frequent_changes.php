<?php
/**
 * non_frequent_changes Class
 *
 * @used in  				non_frequent_changes Function
 * @created  				Hyella Nathan | 19:34 | 22-Aug-2023
 * @database table name   	non_frequent_changes
 */
	
	class cNon_frequent_changes extends cCustomer_call_log{
		...
		public $table_name = 'non_frequent_changes';
