<?php
    ...
    $host = defined('RABBITMQ_HOST') && RABBITMQ_HOST ? RABBITMQ_HOST : '10.1.44.20'; // Problems with loadENV on the 10.1.44.20 server (hot quick fix)
    $port = defined('RABBITMQ_PORT') && RABBITMQ_PORT ? RABBITMQ_PORT : 5672;
    ...
    $callback = function ( $msg ) use ($pagepointer, $nwpApp) {
        try{
            ...
            echo "\n [*] [ERROR] [". date("d-m-Y H:i:s") ."] [". $e->getMessage() ."] \n ";
        }
