...
<style type="text/css">
	<?php if( file_exists( dirname( __FILE__ ).'/get-html-canvas.css' ) )include "get-html-canvas.css"; ?>
</style>
<?php
		...
		<div class="col-md-2 ">
			...
			<div >
				<form id="drag-drop-form" method="post" action="?action=database_forms&todo=drag_drop_save" class="activate-ajax">
					...
					<textarea class="hyella-dataX" name="form_script_header" style="display:none;"><?php echo $script_header; ?></textarea>
					<textarea class="hyella-dataX" name="form_script" style="display:none;"><?php echo $script; ?></textarea>
					
					<?php
						if( ( isset( $form_data ) && $form_data ) && ( isset( $record_id ) && $record_id ) ){
...
<script type="text/javascript" >
	var xdata = <?php echo $form_data ? $form_data : "''"; ?>;
	var id = '<?php echo $record_id; ?>';
