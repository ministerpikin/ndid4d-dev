...
if( isset( $data["items"] ) && is_array( $data["items"] ) && !empty( $data["items"] ) ){
	...
	unset( $GLOBALS["fields"]["store"] );
	unset( $GLOBALS["fields"]["pay_roll"] );
	unset( $GLOBALS["fields"]["account_number"] );
	
	unset( $GLOBALS["fields"]["terms"] );
	unset( $GLOBALS["fields"]["currency"] );
	unset( $GLOBALS["fields"]["opening_balance_credit"] );
	unset( $GLOBALS["fields"]["opening_balance_debit"] );
