		   ...
		   <?php 
			...
			foreach( $tabs as $tk => $tval ){
				...
				if( $visible_tabs_count > $no_of_visible_tabs ){
					$more_tabs .= '<li ><a href="#'. $tk .'" id="'. $tk .'" class="custom-single-selected-record-button empty-tab more-tab" override-selected-record="1" action="'. $tval["action"] .'" data-toggle="tab">'. $tval["title"] .'</a></li>';
				}else{
				?>
