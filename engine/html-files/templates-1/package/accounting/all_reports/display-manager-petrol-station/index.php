...
?>
	<div class="tabbable-custom " id="main-tabs">
		<ul class="nav nav-tabs ">
		   <li class="active"><a href="#search-for-patient" class="custom-single-selected-record-button" override-selected-record="" action="?action=pump_transaction&todo=display_new_team_form" data-toggle="tab">Create Team(s)</a></li>
