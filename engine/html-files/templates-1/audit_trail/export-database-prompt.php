...
<div class="row">
	<div class="col-md-9 col-md-offset-1">
		...
		<hr />
		<div class="row" >
			<?php if( 0 && isset( $data["show_export"] ) && $data["show_export"] ){ ?>
			<div class="col-md-4">
			...
			<div class="col-md-4 col-md-offset-4x">
				...
				<?php 
					if( isset( $data["exported_databases"] ) && ! empty( $data["exported_databases"] ) ){
						...
						?>
						<a style="float:right;" class="btn btn-smX blue text-white custom-single-selected-record-button pull-right" override-selected-record="1" style="color:#333;" action="?action=audit&todo=open_backup_directory<?php echo $params; ?>" title="Click to Open DB Back-up Directory">DB Back-up Directory</a>
						<br />
						<?php
						}
						?>
			...
			<div class="col-md-4 col-md-offset-4x">
				...
				<?php 
					if( isset( $data["exported_files"] ) && ! empty( $data["exported_files"] ) ){
						if( isset( $data["show_export"] ) && $data["show_export"] ){
						?>
						<a style="float:right;" class="btn btn-smX blue text-white custom-single-selected-record-button pull-right" override-selected-record="1" style="color:#333;" action="?action=audit&todo=open_backup_directory<?php echo $params; ?>&dir=dump-files" title="Click to Open Files Back-up Directory">Files Back-up Directory</a>
						<br />
						<?php
						}
						?>
